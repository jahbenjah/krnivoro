...
-- Tiempo de generación: 06-03-2026 a las 18:15:23
...
--
-- Base de datos: `karnivor_krnivoro`
--
CREATE DATABASE IF NOT EXISTS `karnivor_krnivoro` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `karnivor_krnivoro`;
